...
# def initialize_models(environment, env, device, transfer):
#     high_level_model = CNNDQN(env.high_level_observation_space.shape, env.high_level_action_space.n)
#     low_level_model = CNNDQN(env.low_level_observation_space.shape, env.low_level_action_space.n)
#
#     if transfer:
#         high_level_model, low_level_model = load_model(environment, high_level_model, low_level_model)
#
#     return high_level_model, low_level_model
